...
//=========  (Thu Nov 24 13:51:52 2016) by ROOT version5.34/18
   ...
   Graph_Graph10->SetMinimum(0.001080367);
   Graph_Graph10->SetMaximum(0.2121128);
   ...
   Graph_Graph11->SetMinimum(0.001617468);
   Graph_Graph11->SetMaximum(0.1371321);
